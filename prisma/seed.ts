...
const priceRules: Record<string, RuleSeed[]> = {
  ...
  // ONE Mug product; every mug type is a variant with qty tiers (5/10/25/50).
  Mug: [
    ...
    { type: "VARIANT", label: "Neon Color Mug", minQty: 5, unitPrice: 210 },
    { type: "VARIANT", label: "Neon Color Mug", minQty: 10, unitPrice: 195 },
    { type: "VARIANT", label: "Neon Color Mug", minQty: 25, unitPrice: 185 },
    { type: "VARIANT", label: "Neon Color Mug", minQty: 50, unitPrice: 175 },
    { type: "VARIANT", label: "Clear/Frosted Mug", minQty: 5, unitPrice: 220 },
    { type: "VARIANT", label: "Clear/Frosted Mug", minQty: 10, unitPrice: 210 },
    { type: "VARIANT", label: "Clear/Frosted Mug", minQty: 25, unitPrice: 200 },
    { type: "VARIANT", label: "Clear/Frosted Mug", minQty: 50, unitPrice: 195 },
    { type: "VARIANT", label: "Clear/Frosted Beer Mug", minQty: 5, unitPrice: 390 },
    { type: "VARIANT", label: "Clear/Frosted Beer Mug", minQty: 10, unitPrice: 375 },
    { type: "VARIANT", label: "Clear/Frosted Beer Mug", minQty: 25, unitPrice: 360 },
    { type: "VARIANT", label: "Clear/Frosted Beer Mug", minQty: 50, unitPrice: 350 },
    { type: "VARIANT", label: "Enamel Mug", minQty: 5, unitPrice: 280 },
    { type: "VARIANT", label: "Enamel Mug", minQty: 10, unitPrice: 260 },
    { type: "VARIANT", label: "Enamel Mug", minQty: 25, unitPrice: 250 },
    { type: "VARIANT", label: "Enamel Mug", minQty: 50, unitPrice: 240 },
    { type: "VARIANT", label: "Gold/Silver Glitter Mug", minQty: 5, unitPrice: 240 },
    { type: "VARIANT", label: "Gold/Silver Glitter Mug", minQty: 10, unitPrice: 230 },
    { type: "VARIANT", label: "Gold/Silver Glitter Mug", minQty: 25, unitPrice: 225 },
    { type: "VARIANT", label: "Gold/Silver Glitter Mug", minQty: 50, unitPrice: 220 },
    { type: "VARIANT", label: "Heart Handle Glitter Magic Mug", minQty: 5, unitPrice: 240 },
    { type: "VARIANT", label: "Heart Handle Glitter Magic Mug", minQty: 10, unitPrice: 230 },
    { type: "VARIANT", label: "Heart Handle Glitter Magic Mug", minQty: 25, unitPrice: 225 },
    { type: "VARIANT", label: "Heart Handle Glitter Magic Mug", minQty: 50, unitPrice: 220 },
  ],
  Frame: [
